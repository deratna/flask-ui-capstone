...
def index():
    ...
    # Statistik
    top_category = pd.crosstab(index=df2['Category'], columns='Frekuensi').sort_values(by = 'Frekuensi', ascending=False)
    ...
    return render_template('index.html', result=result, result2=result2, result3=result3,result4=result4)
